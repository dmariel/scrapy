...
<head>
    ...
    <title>Coverage for .tox/py/lib/python3.6/site-packages/scrapy/utils/request.py: 66%</title>
...
<div id="header">
    <div class="content">
        <h1>Coverage for <b>.tox/py/lib/python3.6/site-packages/scrapy/utils/request.py</b> :
...
<div id="source">
    ...
    <p id="t52" class="par run show_par"><span class="n"><a href="#t52">52</a></span><span class="t">    <span class="key">if</span> <span class="nam">include_headers</span><span class="op">:</span>&nbsp;</span><span class="r"><span class="annotate short">52&#x202F;&#x219B;&#x202F;53</span><span class="annotate long">line 52 didn't jump to line 53, because the condition on line 52 was never true</span></span></p>
    <p id="t53" class="mis show_mis"><span class="n"><a href="#t53">53</a></span><span class="t">        <span class="nam">include_headers</span> <span class="op">=</span> <span class="nam">tuple</span><span class="op">(</span><span class="nam">to_bytes</span><span class="op">(</span><span class="nam">h</span><span class="op">.</span><span class="nam">lower</span><span class="op">(</span><span class="op">)</span><span class="op">)</span> <span class="key">for</span> <span class="nam">h</span> <span class="key">in</span> <span class="nam">sorted</span><span class="op">(</span><span class="nam">include_headers</span><span class="op">)</span><span class="op">)</span>&nbsp;</span><span class="r"></span></p>
    ...
    <p id="t56" class="par run show_par"><span class="n"><a href="#t56">56</a></span><span class="t">    <span class="key">if</span> <span class="nam">cache_key</span> <span class="key">not</span> <span class="key">in</span> <span class="nam">cache</span><span class="op">:</span>&nbsp;</span><span class="r"><span class="annotate short">56&#x202F;&#x219B;&#x202F;68</span><span class="annotate long">line 56 didn't jump to line 68, because the condition on line 56 was never false</span></span></p>
    ...
    <p id="t61" class="par run show_par"><span class="n"><a href="#t61">61</a></span><span class="t">        <span class="key">if</span> <span class="nam">include_headers</span><span class="op">:</span>&nbsp;</span><span class="r"><span class="annotate short">61&#x202F;&#x219B;&#x202F;62</span><span class="annotate long">line 61 didn't jump to line 62, because the condition on line 61 was never true</span></span></p>
    <p id="t62" class="mis show_mis"><span class="n"><a href="#t62">62</a></span><span class="t">            <span class="key">for</span> <span class="nam">hdr</span> <span class="key">in</span> <span class="nam">include_headers</span><span class="op">:</span>&nbsp;</span><span class="r"></span></p>
    <p id="t63" class="mis show_mis"><span class="n"><a href="#t63">63</a></span><span class="t">                <span class="key">if</span> <span class="nam">hdr</span> <span class="key">in</span> <span class="nam">request</span><span class="op">.</span><span class="nam">headers</span><span class="op">:</span>&nbsp;</span><span class="r"></span></p>
    <p id="t64" class="mis show_mis"><span class="n"><a href="#t64">64</a></span><span class="t">                    <span class="nam">fp</span><span class="op">.</span><span class="nam">update</span><span class="op">(</span><span class="nam">hdr</span><span class="op">)</span>&nbsp;</span><span class="r"></span></p>
    <p id="t65" class="mis show_mis"><span class="n"><a href="#t65">65</a></span><span class="t">                    <span class="key">for</span> <span class="nam">v</span> <span class="key">in</span> <span class="nam">request</span><span class="op">.</span><span class="nam">headers</span><span class="op">.</span><span class="nam">getlist</span><span class="op">(</span><span class="nam">hdr</span><span class="op">)</span><span class="op">:</span>&nbsp;</span><span class="r"></span></p>
    <p id="t66" class="mis show_mis"><span class="n"><a href="#t66">66</a></span><span class="t">                        <span class="nam">fp</span><span class="op">.</span><span class="nam">update</span><span class="op">(</span><span class="nam">v</span><span class="op">)</span>&nbsp;</span><span class="r"></span></p>
    ...
    <p id="t75" class="mis show_mis"><span class="n"><a href="#t75">75</a></span><span class="t">    <span class="nam">request</span><span class="op">.</span><span class="nam">headers</span><span class="op">[</span><span class="str">'Authorization'</span><span class="op">]</span> <span class="op">=</span> <span class="nam">basic_auth_header</span><span class="op">(</span><span class="nam">username</span><span class="op">,</span> <span class="nam">password</span><span class="op">)</span>&nbsp;</span><span class="r"></span></p>
    ...
    <p id="t88" class="par run show_par"><span class="n"><a href="#t88">88</a></span><span class="t">    <span class="key">if</span> <span class="nam">request</span><span class="op">.</span><span class="nam">headers</span><span class="op">:</span>&nbsp;</span><span class="r"><span class="annotate short">88&#x202F;&#x219B;&#x202F;90</span><span class="annotate long">line 88 didn't jump to line 90, because the condition on line 88 was never false</span></span></p>
    ...
    <p id="t98" class="par run show_par"><span class="n"><a href="#t98">98</a></span><span class="t">    <span class="key">if</span> <span class="nam">referrer</span> <span class="key">is</span> <span class="key">None</span><span class="op">:</span>&nbsp;</span><span class="r"><span class="annotate short">98&#x202F;&#x219B;&#x202F;100</span><span class="annotate long">line 98 didn't jump to line 100, because the condition on line 98 was never false</span></span></p>
    ...
    <p id="t100" class="mis show_mis"><span class="n"><a href="#t100">100</a></span><span class="t">    <span class="key">return</span> <span class="nam">to_unicode</span><span class="op">(</span><span class="nam">referrer</span><span class="op">,</span> <span class="nam">errors</span><span class="op">=</span><span class="str">'replace'</span><span class="op">)</span>&nbsp;</span><span class="r"></span></p>
</div>
<div id="footer">
    <div class="content">
        <p>
