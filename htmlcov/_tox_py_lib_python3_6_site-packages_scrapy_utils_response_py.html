...
<head>
    ...
    <title>Coverage for .tox/py/lib/python3.6/site-packages/scrapy/utils/response.py: 45%</title>
...
<div id="header">
    <div class="content">
        <h1>Coverage for <b>.tox/py/lib/python3.6/site-packages/scrapy/utils/response.py</b> :
...
<div id="source">
    ...
    <p id="t20" class="mis show_mis"><span class="n"><a href="#t20">20</a></span><span class="t">    <span class="key">if</span> <span class="nam">response</span> <span class="key">not</span> <span class="key">in</span> <span class="nam">_baseurl_cache</span><span class="op">:</span>&nbsp;</span><span class="r"></span></p>
    <p id="t21" class="mis show_mis"><span class="n"><a href="#t21">21</a></span><span class="t">        <span class="nam">text</span> <span class="op">=</span> <span class="nam">response</span><span class="op">.</span><span class="nam">text</span><span class="op">[</span><span class="num">0</span><span class="op">:</span><span class="num">4096</span><span class="op">]</span>&nbsp;</span><span class="r"></span></p>
    <p id="t22" class="mis show_mis"><span class="n"><a href="#t22">22</a></span><span class="t">        <span class="nam">_baseurl_cache</span><span class="op">[</span><span class="nam">response</span><span class="op">]</span> <span class="op">=</span> <span class="nam">html</span><span class="op">.</span><span class="nam">get_base_url</span><span class="op">(</span><span class="nam">text</span><span class="op">,</span> <span class="nam">response</span><span class="op">.</span><span class="nam">url</span><span class="op">,</span> <span class="nam">response</span><span class="op">.</span><span class="nam">encoding</span><span class="op">)</span>&nbsp;</span><span class="r"></span></p>
    <p id="t23" class="mis show_mis"><span class="n"><a href="#t23">23</a></span><span class="t">    <span class="key">return</span> <span class="nam">_baseurl_cache</span><span class="op">[</span><span class="nam">response</span><span class="op">]</span>&nbsp;</span><span class="r"></span></p>
    ...
    <p id="t31" class="par run show_par"><span class="n"><a href="#t31">31</a></span><span class="t">    <span class="key">if</span> <span class="nam">response</span> <span class="key">not</span> <span class="key">in</span> <span class="nam">_metaref_cache</span><span class="op">:</span>&nbsp;</span><span class="r"><span class="annotate short">31&#x202F;&#x219B;&#x202F;35</span><span class="annotate long">line 31 didn't jump to line 35, because the condition on line 31 was never false</span></span></p>
    ...
    <p id="t41" class="mis show_mis"><span class="n"><a href="#t41">41</a></span><span class="t">    <span class="nam">message</span> <span class="op">=</span> <span class="nam">http</span><span class="op">.</span><span class="nam">RESPONSES</span><span class="op">.</span><span class="nam">get</span><span class="op">(</span><span class="nam">int</span><span class="op">(</span><span class="nam">status</span><span class="op">)</span><span class="op">,</span> <span class="str">"Unknown Status"</span><span class="op">)</span>&nbsp;</span><span class="r"></span></p>
    <p id="t42" class="mis show_mis"><span class="n"><a href="#t42">42</a></span><span class="t">    <span class="key">return</span> <span class="str">f'{status} {to_unicode(message)}'</span>&nbsp;</span><span class="r"></span></p>
    ...
    <p id="t57" class="par run show_par"><span class="n"><a href="#t57">57</a></span><span class="t">    <span class="key">if</span> <span class="nam">response</span><span class="op">.</span><span class="nam">headers</span><span class="op">:</span>&nbsp;</span><span class="r"><span class="annotate short">57&#x202F;&#x219B;&#x202F;59</span><span class="annotate long">line 57 didn't jump to line 59, because the condition on line 57 was never false</span></span></p>
    ...
    <p id="t67" class="mis show_mis"><span class="n"><a href="#t67">67</a></span><span class="t">    <span class="key">from</span> <span class="nam">scrapy</span><span class="op">.</span><span class="nam">http</span> <span class="key">import</span> <span class="nam">HtmlResponse</span><span class="op">,</span> <span class="nam">TextResponse</span>&nbsp;</span><span class="r"></span></p>
    ...
    <p id="t69" class="mis show_mis"><span class="n"><a href="#t69">69</a></span><span class="t">    <span class="nam">body</span> <span class="op">=</span> <span class="nam">response</span><span class="op">.</span><span class="nam">body</span>&nbsp;</span><span class="r"></span></p>
    <p id="t70" class="mis show_mis"><span class="n"><a href="#t70">70</a></span><span class="t">    <span class="key">if</span> <span class="nam">isinstance</span><span class="op">(</span><span class="nam">response</span><span class="op">,</span> <span class="nam">HtmlResponse</span><span class="op">)</span><span class="op">:</span>&nbsp;</span><span class="r"></span></p>
    <p id="t71" class="mis show_mis"><span class="n"><a href="#t71">71</a></span><span class="t">        <span class="key">if</span> <span class="str">b'&lt;base'</span> <span class="key">not</span> <span class="key">in</span> <span class="nam">body</span><span class="op">:</span>&nbsp;</span><span class="r"></span></p>
    <p id="t72" class="mis show_mis"><span class="n"><a href="#t72">72</a></span><span class="t">            <span class="nam">repl</span> <span class="op">=</span> <span class="str">f'&lt;head>&lt;base href="{response.url}">'</span>&nbsp;</span><span class="r"></span></p>
    <p id="t73" class="mis show_mis"><span class="n"><a href="#t73">73</a></span><span class="t">            <span class="nam">body</span> <span class="op">=</span> <span class="nam">body</span><span class="op">.</span><span class="nam">replace</span><span class="op">(</span><span class="str">b'&lt;head>'</span><span class="op">,</span> <span class="nam">to_bytes</span><span class="op">(</span><span class="nam">repl</span><span class="op">)</span><span class="op">)</span>&nbsp;</span><span class="r"></span></p>
    <p id="t74" class="mis show_mis"><span class="n"><a href="#t74">74</a></span><span class="t">        <span class="nam">ext</span> <span class="op">=</span> <span class="str">'.html'</span>&nbsp;</span><span class="r"></span></p>
    ...
    <p id="t80" class="mis show_mis"><span class="n"><a href="#t80">80</a></span><span class="t">    <span class="nam">fd</span><span class="op">,</span> <span class="nam">fname</span> <span class="op">=</span> <span class="nam">tempfile</span><span class="op">.</span><span class="nam">mkstemp</span><span class="op">(</span><span class="nam">ext</span><span class="op">)</span>&nbsp;</span><span class="r"></span></p>
    <p id="t81" class="mis show_mis"><span class="n"><a href="#t81">81</a></span><span class="t">    <span class="nam">os</span><span class="op">.</span><span class="nam">write</span><span class="op">(</span><span class="nam">fd</span><span class="op">,</span> <span class="nam">body</span><span class="op">)</span>&nbsp;</span><span class="r"></span></p>
    <p id="t82" class="mis show_mis"><span class="n"><a href="#t82">82</a></span><span class="t">    <span class="nam">os</span><span class="op">.</span><span class="nam">close</span><span class="op">(</span><span class="nam">fd</span><span class="op">)</span>&nbsp;</span><span class="r"></span></p>
    <p id="t83" class="mis show_mis"><span class="n"><a href="#t83">83</a></span><span class="t">    <span class="key">return</span> <span class="nam">_openfunc</span><span class="op">(</span><span class="str">f"file://{fname}"</span><span class="op">)</span>&nbsp;</span><span class="r"></span></p>
</div>
<div id="footer">
    <div class="content">
        <p>
