...
<head>
    ...
    <title>Coverage for .tox/py/lib/python3.6/site-packages/scrapy/core/__init__.py: 100%</title>
...
<div id="header">
    <div class="content">
        <h1>Coverage for <b>.tox/py/lib/python3.6/site-packages/scrapy/core/__init__.py</b> :
...
<div id="source">
    ...
    <p id="t2" class="pln"><span class="n"><a href="#t2">2</a></span><span class="t"><span class="str">Scrapy core library classes and functions.</span>&nbsp;</span><span class="r"></span></p>
